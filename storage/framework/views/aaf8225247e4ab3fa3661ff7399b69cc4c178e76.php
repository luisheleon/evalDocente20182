<?php if($request['tipo'] == 1): ?>
    ...
    <?php echo Form::open(['route' => 'politica.store', 'method' => 'POST',  'class' => 'form-horizontal']); ?>
            ...
            <div class="modal-body">
                <div class="container">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <?php echo Form::text('nompolitica',null,['required','class' => 'form-control', 'placeholder' => 'Nombre del politica']); ?>
