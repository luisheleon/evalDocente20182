<?php $__env->startSection('titulo','Preguntas'); ?>
<?php $__env->startSection('titulopag','Preguntas'); ?>
...
<?php $__env->startSection('contenido'); ?>
    ...
    <br><br>
    <?php echo Form::open(['route' => 'pregunta.preguntaView', 'method' => 'POST',  'class' => 'form-horizontal','id' => 'form']); ?>
    ...
    <div class="container table-responsive" style="width:80%">
        <table class="table table-striped table-bordered " id="tableFront" align="center">
            ...
            <?php $__currentLoopData = $pregunta; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td align="center">
                        <div class="i-checks" style="width:10px; height:10px;"><input type="radio" name="id" id="id" value="<?php echo e($pre->id); ?>">
                        </div>
                    </td>
                    <td><?php echo e($pre->pregunta); ?></td>
                    <td><?php if($pre->estado == 1): ?> Activo <?php else: ?> Deshabilitado <?php endif; ?></td>
                </tr>
