...
<?php $__env->startSection('contenido'); ?>
    ...
    <br><br>
    <?php echo Form::open(['route' => 'perfil.View', 'method' => 'POST',  'class' => 'form-horizontal','id' => 'form']); ?>
    ...
    <div class="container table-responsive" style="width:80%">
        <table class="table table-striped table-bordered " id="tableFront" align="center">
            ...
            <?php $__currentLoopData = $perfil; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $per): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td align="center">
                        <div class="i-checks" style="width:10px; height:10px;"><input type="radio" name="id" id="Id" value="<?php echo e($per->id); ?>">
                        </div>
                    </td>
                    <td><?php echo e($per->perfil); ?></td>
                </tr>
