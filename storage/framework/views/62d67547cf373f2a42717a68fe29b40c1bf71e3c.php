            ...
            <div class="modal-body">
                <div class="container">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <?php echo Form::select('actor_id',$actor, null,['required','class'=>'form-control','placeholder' => 'Seleccione','id'=>'actor_id']); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <?php echo Form::select('factor_id',$factor, null,['required','class'=>'form-control','placeholder' => 'Seleccione','id'=>'factor_id']); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <?php echo Form::select('criterio_id',$criterio, null,['required','class'=>'form-control','placeholder' => 'Seleccione','id'=>'criterio_id']); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <?php echo Form::select('indicador_id',$indicador, null,['required','class'=>'form-control','placeholder' => 'Seleccione','id'=>'indicador_id']); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <?php echo Form::select('pregunta_id',$pregunta, null,['required','class'=>'form-control','placeholder' => 'Seleccione','id'=>'pregunta_id']); ?>

                        </div>
                    </div>

                    <?php echo Form::hidden('politica_id',$request['politica_id']); ?>
...
<?php if($request['tipo']==3): ?>
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
            <?php echo Form::select('criterio_id',$criterios, null,['required','class'=>'form-control','onchange'=>"ajaxselect(4,'#divIndicador')",'placeholder' => 'Seleccione']); ?>
...
<?php endif; ?>
    ...
    <!--indicador-->
<?php if($request['tipo']==4): ?>

    <div class="form-group">
        <?php echo Form::label('lblName','Indicador',['class' => 'control-label col-md-3']); ?>

        <div class="col-md-4">
            <?php echo Form::select('indicador_id',$indicadores, null,['required','class'=>'form-control','onchange'=>"ajaxselect(5,'#divPregunta')",'placeholder' => 'Seleccione']); ?>
...
<?php if($request['tipo']==5): ?>
    <div class="form-group">
        <?php echo Form::label('lblName','Pregunta',['class' => 'control-label col-md-3']); ?>

        <div class="col-md-4">
            <?php echo Form::select('pregunta_id',$preguntas, null,['required','class'=>'form-control','placeholder' => 'Seleccione']); ?>
